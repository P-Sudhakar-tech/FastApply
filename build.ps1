...
# point the venv at the repo root via a .pth file so `import turboply`
...
cargo build --release
Copy-Item -Force "target\release\_turboply.dll" "turboply\_turboply.pyd"
...
Write-Host "Built turboply\_turboply.pyd"
Write-Host "Linked $repoRoot into the venv via turboply.pth"
